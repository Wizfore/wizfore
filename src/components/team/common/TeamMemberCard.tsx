      ...
      >
        ...
        >
          <h3 
            ...
            className="text-xl lg:text-2xl font-black text-wizfore-text-primary mb-4"
          >
            {member.name}
          </h3>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-wizfore-warm-brown/5 to-transparent p-4 rounded-lg border border-wizfore-warm-brown/10 hover:border-wizfore-warm-brown/20 transition-colors duration-300">
            <div className="flex items-center mb-3">
              <GraduationCap className="w-4 h-4 text-wizfore-coral-primary mr-3 group-hover:scale-110 transition-transform duration-300 motion-reduce:transition-none motion-reduce:group-hover:scale-100" aria-hidden="true" />
          ...
          <div className="bg-gradient-to-r from-wizfore-soft-pink/8 to-transparent p-4 rounded-lg border border-wizfore-soft-pink/20 hover:border-wizfore-soft-pink/30 transition-colors duration-300">
            <div className="flex items-center mb-3">
              <Award className="w-4 h-4 text-wizfore-coral-primary mr-3 group-hover:scale-110 transition-transform duration-300 motion-reduce:transition-none motion-reduce:group-hover:scale-100" aria-hidden="true" />
              <h4 className="text-base font-bold text-wizfore-text-primary">
                {certificationsLabel}
              </h4>
            </div>

...
import { Plus, Edit, Trash2, Brain, FileText, Target, ArrowUp, ArrowDown, Hash } from 'lucide-react'
...
interface CounselingManagementTabProps {
...
export function CounselingManagementTab({
  data,
  onUpdate,
  onUnsavedChanges,
  onRegisterCallback,
  onRegisterCleanupCallback
}: CounselingManagementTabProps) {
  ...
  const handleSaveSuccess = React.useCallback(async () => {
    ...
    stopTrackingAllImages()
    markAsSaved()
    console.log('Counseling 탭: 삭제 예정 이미지 처리 완료, 이미지 추적 중단 및 저장 완료 표시')
  ...
  const handleDiscardChanges = React.useCallback(async () => {
    ...
    console.log('Counseling 탭: 이미지 정리 완료')
  }, [performCleanup])
  ...
  React.useEffect(() => {
    if (onRegisterCallback) {
      ...
      console.log('Counseling 탭: 저장 성공 콜백 등록')
    }
  }, [onRegisterCallback, handleSaveSuccess])
  ...
  React.useEffect(() => {
    if (onRegisterCleanupCallback) {
      ...
      console.log('Counseling 탭: 정리 콜백 등록')
    }
  }, [onRegisterCleanupCallback, handleDiscardChanges])
  ...
  return (
    <div className="space-y-6">
      {/* 히어로 섹션 */}
      <AdminSection title="히어로 섹션" description="상담 프로그램 페이지의 히어로 섹션을 관리합니다.">
        <AdminInput
          label="페이지 제목"
      ...
      {/* 소개 메시지 */}
      <AdminSection title="소개 메시지" description="상담 프로그램 소개 메시지를 관리합니다.">
        <AdminInput
          label="제목"
                  ...
                  <div className="space-y-4 mt-4 pt-4 border-t">
                    ...
                    <div className="bg-slate-50 rounded-lg p-4">
                      ...
                      <AdminImageUploadField
                        ...
                        folder={`pages/programs/counseling/program-${index + 1}`}
